...
class NeighborhoodsControllerTest < ActionController::TestCase
  ...
  test "should create neighborhood" do
    assert_difference('Neighborhood.count') do
      post :create, neighborhood: { name: @neighborhood.name, picture_url_big: @neighborhood.picture_url_big, picture_url_normal: @neighborhood.picture_url_normal, picture_url_thumb: @neighborhood.picture_url_thumb }
    end
  ...
  test "should update neighborhood" do
    put :update, id: @neighborhood, neighborhood: { name: @neighborhood.name, picture_url_big: @neighborhood.picture_url_big, picture_url_normal: @neighborhood.picture_url_normal, picture_url_thumb: @neighborhood.picture_url_thumb }
    assert_redirected_to neighborhood_path(assigns(:neighborhood))
  end

...
User.create(first_name: 'Centro Comercial', last_name: 'Tlalpan', email: 'centro_comercial@tlalpan.com', password: 'tlalpantlalpan', roles: [role_external], neighborhood_id: 1, kilometers: 0)
...
User.create(first_name: 'Centro Comercial', last_name: 'Juarez', email: 'centro_comercial@juarez.com', password: 'juarezjuarez', roles: [role_external], neighborhood_id: 4, kilometers: 0)
...
User.create(first_name: 'Centro Comercial', last_name: 'Condesa', email: 'centro_comercial@condesa.com', password: 'condesacondesa', roles: [role_external], neighborhood_id: 9, kilometers: 0)
User.create(first_name: 'Centro Comercial', last_name: 'Coapa', email: 'centro_comercial@coapa.com', password: 'coapacoapa', roles: [role_external], neighborhood_id: 10, kilometers: 0)
...
User.create(first_name: 'Centro Comercial', last_name: 'Tepito', email: 'centro_comercial@tepito.com', password: 'tepitotepito', roles: [role_external], neighborhood_id: 13, kilometers: 0)
